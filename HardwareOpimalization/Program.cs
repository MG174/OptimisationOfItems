...
//var A = [{ "name" = "a1"; "X" = 5000; "Y" = 1000 }, { "name" = "a2"; "X" = 2000; "Y" = 1000}]
//var B = [{ "name" = "b1"; "X" = 1400; "Y" = 1000 }, { "name" = "b2"; "X" = 2000; "Y" = 900}]
//var C = [{ "name" = "c1"; "X" = 1300; "Y" = 1000 }, { "name" = "c2"; "X" = 2000; "Y" = 900}]
//var D = [{ "name" = "d1"; "X" = 6000; "Y" = 1000 }, { "name" = "d2"; "X" = 2000; "Y" = 1500}]
//var E = [{ "name" = "e1"; "X”=”1100”; ”Y”=”1000” }, {„name”=”e2”; „X”=”2000”; ”Y”=”2000”}]